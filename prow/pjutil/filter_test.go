...
func TestPresubmitFilter(t *testing.T) {
	...
	var testCases = []struct {
		...
		},
		{
			...
			expected: [][]bool{{false, false, false}, {false, false, false}, {true, true, true}, {true, true, true}, {true, false, true}},
		},
		{
...
/retest`,
			...
			expected: [][]bool{{true, false, false}, {true, false, false}, {true, true, true}, {false, false, false}, {false, false, false}, {true, true, true}, {true, true, true}, {true, false, true}},
		},
	}
